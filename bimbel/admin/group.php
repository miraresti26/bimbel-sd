...
<body class = "alert-warning">
	...
	<div class = "container-fluid">
		<ul class="nav nav-pills">
			...
			<li><a href="member.php">Peserta Bimbel</a></li>
			<li class="active"><a href="club.php">Mata Pelajaran</a></li>
		</ul>
		<br />
		<div class = "col-md-12 well">
			<button type = "button" class = "btn btn-success"  data-toggle="modal" data-target="#myModal"><span class = "glyphicon glyphicon-plus"></span> Tambah Peserta</button>
			...
			?>
				<div class = "alert alert-success"><?php echo $c_fetch['club_name']?> / Daftar Peserta</div>
			<table id = "table" class = "table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><center><a  href = "delete_group.php?group_id=<?php echo $f_query['group_id']?>&club_id=<?php echo $f_query['club_id']?>" class = "btn btn-danger"><span class = "glyphicon glyphicon-trash"></span> Delete</a></center></td>
						</tr>
						<?php
							}
						?>
