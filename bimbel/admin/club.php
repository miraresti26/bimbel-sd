				...
				<table id = "table" class = "table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><center><a href = "group.php?club_id=<?php echo $f_query['club_id']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-eye-open"></span>  Daftar Peserta</a> | <a href = "club_edit.php?club_id=<?php echo $f_query['club_id']?>" class = "btn btn-warning"><span class = "glyphicon glyphicon-edit"></span>  Update</a> | <a  href = "delete_club.php?club_id=<?php echo $f_query['club_id']?>" class = "btn btn-danger"><span class = "glyphicon glyphicon-trash"></span> Delete</a></center></td>
						</tr>
						<?php
							}
						?>
